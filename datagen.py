...
from overrides.cdatabase import CDatabase

# add database
my_db = CDatabase(db_name="C##ZSBD")

# add tables
my_db.add_table(table_name="CrewMember", n_rows=3)
my_db.add_table(table_name="Genre", n_rows=3)
my_db.add_table(table_name="Country", n_rows=3)
my_db.add_table(table_name="Award", n_rows=3)
...
my_db.tables["CrewMember"].add_column_custom(column_name="Gender", data_target="bothify", data_type="char(1)", text="?",
                                             letters="MF")
my_db.tables["CrewMember"].add_column_custom(column_name="BirthDate", data_target="date", data_type="date")
my_db.tables["CrewMember"].add_column_custom(column_name="Height", data_target="random_int", data_type="number(10)",
                                             min=150, max=210)

my_db.tables["Movie"].add_primary_key(column_name="MovieId")
my_db.tables["Movie"].add_column_custom(column_name="Title", data_target="sentence", data_type="varchar(255)",
                                        nb_words=3)
my_db.tables["Movie"].add_column_custom(column_name="PremiereDate", data_target="date", data_type="date")
my_db.tables["Movie"].add_column_custom(column_name="Duration", data_target="random_int", data_type="number(10)",
                                        min=30, max=360)
my_db.tables["Movie"].add_column_custom(column_name="Budget", data_target="pyfloat", data_type="float(10)",
...
my_db.tables["Movie"].add_column_custom(column_name="Promo", data_target="pyfloat", data_type="float(10)",
...
my_db.tables["Genre"].add_column_custom(column_name="Name", data_target="word", data_type="varchar(255)",
...
my_db.tables["Award"].add_column_custom(column_name="IsWinner", data_target="pyint", data_type="number", min_value=0,
                                        max_value=1)
...
my_db.tables["Rate"].add_column_custom(column_name="Value", data_target="pyint", data_type="number(10)", min_value=0,
                                       max_value=10)
my_db.tables["Rate"].add_column_custom(column_name="Title", data_target="sentence", data_type="varchar(255)",
                                       nb_words=3)
...
my_db.tables["Rate"].add_column_custom(column_name="Verified", data_target="pyint", data_type="number", min_value=0,
                                       max_value=1)
my_db.tables["Rate"].add_column_custom(column_name="Views", data_target="random_int", data_type="number(10)", min=30,
                                       max=360)

my_db.tables["Customer"].add_primary_key(column_name="CustomerId")
my_db.tables["Customer"].add_column_custom(column_name="Email", data_target="ascii_safe_email",
                                           data_type="varchar(255)")
my_db.tables["Customer"].add_column_custom(column_name="Login", data_target="simple_profile", data_type="varchar(255)",
                                           fields="username")
...
my_db.tables["Customer"].add_column_custom(column_name="FreeMovies", data_target="random_int", data_type="number(10)",
                                           min=0, max=5)
my_db.tables["Customer"].add_column_custom(column_name="EmailVerified", data_target="pyint", data_type="number",
...
my_db.tables["Rent"].add_column_custom(column_name="Price", data_target="pyfloat", data_type="float(10)",
                                       left_digits=None, right_digits=2, positive=True, min_value=200000,
                                       max_value=9999999)
my_db.tables["Rent"].add_column_custom(column_name="Quality", data_target="random_int", data_type="number(10)", min=0,
                                       max=5)  # TODO to enum?
my_db.tables["Rent"].add_column_custom(column_name="Period", data_target="random_int", data_type="number(10)", min=30,
                                       max=360)
my_db.tables["Rent"].add_column_custom(column_name="Promo", data_target="pyfloat", data_type="float(10)",
                                       left_digits=None, right_digits=2, positive=True, min_value=0, max_value=1)

my_db.tables["Translation"].add_primary_key(column_name="TranslationId")
my_db.tables["Translation"].add_column_custom(column_name="Type", data_target="random_int", data_type="number(10)",
...
my_db.tables["Language"].add_column_custom(column_name="Name", data_target="language_name", data_type="varchar(255)")
